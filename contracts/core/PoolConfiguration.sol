...
/// @title PoolConfiguration - 池配置合约
/// @notice 管理池的费用参数、资金费率和借款利率
/// @dev 提供池的配置查询和更新功能
///
/// ==================== 配置概述 ====================
///
...
///    - 供应费率: 开仓时收取的费用
///    - 提款费率: 平仓时收取的费用
///    - 借款费率: 借入 fxUSD 时收取的费用
///    - 还款费率: 偿还 fxUSD 时收取的费用
///
/// 2. 资金费率配置
///    - 多头资金费率: 基于 Aave 利率和 fxUSD 价格状态
///    - 空头资金费率: 基于借款比率
///
/// 3. 借款利率快照
///    - 定期从 Aave 获取借款利率
